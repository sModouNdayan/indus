...
export class MainContentWorkflowComponent implements OnInit {
  ...
  constructor(    private router: Router,
    ...
    columnDefinitions = [
      ...
      { def: 'wkfEtat', label: 'Status', hide: false }, 
    ...
    ngAfterViewInit() {
      ...
      let o4: Observable<boolean> = this.wkfEtat.valueChanges; 
      ...
      merge(o1, o2, o3, o4, o5).subscribe(v => {
        ...
        this.columnDefinitions[3].hide = this.wkfEtat.value; 
